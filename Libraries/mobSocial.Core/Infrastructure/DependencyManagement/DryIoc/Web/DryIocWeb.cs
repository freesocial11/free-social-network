[assembly: System.Web.PreApplicationStartMethod(typeof(DryIoc.Web.DryIocHttpPluginInitializer), "Initialize")]
...
namespace DryIoc.Web
{
    ...
    /// <summary>Registers <see cref="DryIocHttpPlugin"/>.</summary>
    public static class DryIocHttpPluginInitializer
    {
        /// <summary>Registers once the type of <see cref="DryIocHttpPlugin"/>.</summary>
        public static void Initialize()
        {
            if (Interlocked.CompareExchange(ref _initialized, 1, 0) == 0)
                DynamicModuleUtility.RegisterModule(typeof(DryIocHttpPlugin));
        }
    ...
    public sealed class DryIocHttpPlugin : IHttpModule
    {
        ...
        /// <summary>Disposes of the resources (other than memory) used by the plugin  that implements <see cref="IHttpPlugin"/>.</summary>
