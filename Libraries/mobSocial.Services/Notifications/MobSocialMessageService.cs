...
namespace mobSocial.Services.Notifications
{
    ...
    public class MobSocialMessageService : IMobSocialMessageService
    {
        ...
        public int SendBirthdayNotification(User customer, int languageId, int storeId)
        {
        ...
        public int SendSomeoneSentYouASongNotification(User customer, int languageId, int storeId)
        {
        ...
        public int SendSomeoneChallengedYouForABattleNotification(User challenger, string challengeeEmail, string challengeeName, VideoBattle videoBattle,
            int languageId, int storeId)
        {
            var store = _storeService.GetStoreById(storeId) ?? _storeContext.CurrentStore;
            ...
            _messageTokenProvider.AddStoreTokens(tokens, store, emailAccount);
            _messageTokenProvider.AddUserTokens(tokens, challenger);
        ...
        public int SendVideoBattleSignupAcceptedNotification(User challenger, User challengee, VideoBattle videoBattle, int languageId, int storeId)
        {
            var store = _storeService.GetStoreById(storeId) ?? _storeContext.CurrentStore;
        ...
        public int SendVideoBattleDisqualifiedNotification(User challenger, User challengee, VideoBattle videoBattle, int languageId, int storeId)
        {
            var store = _storeService.GetStoreById(storeId) ?? _storeContext.CurrentStore;
        ...
        public int SendVideoBattleOpenNotification(User receiver, VideoBattle videoBattle, int languageId, int storeId)
        {
            var store = _storeService.GetStoreById(storeId) ?? _storeContext.CurrentStore;
        ...
        public int SendSponsorAppliedNotificationToBattleOwner(User owner, User sponsor, VideoBattle videoBattle, int languageId, int storeId)
        {
            var store = _storeService.GetStoreById(storeId) ?? _storeContext.CurrentStore;
            ...
            _messageTokenProvider.AddStoreTokens(tokens, store, emailAccount);
            _messageTokenProvider.AddUserTokens(tokens, owner);
